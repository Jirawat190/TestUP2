...
// const pagedccountry = () => {
//   router.push('/homesetting/dc-countryarea')
// }

const pagepouchcrossdock = () => {
  router.push('/homesetting/pouch&crossdock')
}
    ...
    <>
      ...
      <Card headStyle={{ border: 0, padding: 30 }} title={<Text className="text-2xl" style={{ color: "#191970", fontWeight: "bold" }}> ตั้งค่าคลังสินค้า </Text>} style={{ width: "100%", marginBottom: "20px" }}>
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} style={{ color: '#f57517' }}>
          <Col className="gutter-row" span={6}>
            <Row style={style5}>
              <Row onClick={pagedcarea} className={styles.options} style={{ backgroundColor: "#fdf7ed" }} justify={'center'} align={'middle'}>
                <div>ดูพื้นที่รับผิดชอบของคลัง</div>
                <div>และUpload Route</div>
              </Row>
            </Row>
          </Col>
          ...
          <Col className="gutter-row" span={6}>
            <Row style={style5}>
              <Row onClick={pagepouchcrossdock} className={styles.options} style={{ backgroundColor: "#fdf7ed" }} justify={'center'} align={'middle'}>
                <div>ตั้งค่า Pouch และ Crossdock</div>
              </Row>
            </Row>
          </Col>
           <Col className="gutter-row" span={6}>
            <Row style={style5}>
              <Row className={styles.options} style={{ backgroundColor: "#fdf7ed" }} justify={'center'} align={'middle'}>
                <div>ตั้งค่าสัญลักษณ์คลัง</div>
                <div>ที่ใช้แสดงบน Label Pouch</div>
              </Row>
            </Row>
          </Col>
         {/*<Col className="gutter-row" span={6}>
